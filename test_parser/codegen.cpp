...
GenericValue CodeGenContext::runCode() {
	...
	//Args[0].IntVal = APInt(32, 0);
	GenericValue GV = EE->runFunction(mainFunction, Args);
...
Value* NAssignment::codeGen(CodeGenContext& context)
{
	...
	Value* pVal = context.locals()[lhs.name];

	return new StoreInst(rhs.codeGen(context), pVal, false, context.currentBlock());
}
